...
% 在本项工作的过程中，已投出两篇论文。其中论文《基于LSTM的语言学习长期记忆预测模型》录用于中文核心期刊《中文信息学报》，论文A Stochastic Shortest Path Algorithm for Optimizing Spaced Repetition Scheduling接收于国际数据挖掘顶级会议 2022 ACM SIGKDD。
\end{cabstract}
...
\begin{eabstract}
  ...
  % During this work, two papers have been submitted. The paper titled \textit{A Long-term Memory Prediction Model for Language Learning via LSTM} has been published in Journal of Chinese Information Processing which belongs to Chinese Core Journals. The paper titled \textit{A Stochastic Shortest Path Algorithm for Optimizing Spaced Repetition Scheduling} has been accepted by 2022 ACM SIGKDD Conference which is a top international conference on data mining.
  % Part of this work has been published in Journal of Chinese Information Processing which belongs to Chinese Core Journals. Another paper titled \textit{A Stochastic Shortest Path Algorithm for Optimizing Spaced Repetition Scheduling} has been accepted by 2022 ACM SIGKDD Conference.
